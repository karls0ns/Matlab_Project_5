...
% funkcija parâda lineârâs regresijas modeïa virsmas attçlu
% (derîga tikai datiem ar diviem faktoriem, t.i., ja matricai z ir tieði 2 kolonnas)
	m = size(x,2);
    if (m ~= 2)
        error('linreg_plot3: x matricai jâsatur tieði divas kolonnas.');
    end
